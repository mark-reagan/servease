  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="field-label" htmlFor="linkedin_url">LinkedIn URL</label>
            <input
              id="linkedin_url"
              className="field-input"
          ...
          <div>
            <label className="field-label" htmlFor="portfolio_url">Portfolio URL</label>
            <input
              id="portfolio_url"
              className="field-input"
        ...
        <div>
          <label className="field-label" htmlFor="resume">Resume (PDF or Word)</label>
          <input
            id="resume"
            type="file"
            accept=".pdf,.doc,.docx"
          ...
          {user?.candidate_profile?.resume_path && !resumeFile && (
            <p className="text-xs text-ink-faint mt-1">A resume is already on file.</p>
          )}
        </div>
